...
class MyNotes {
  constructor() {
    if (document.querySelector("#my-notes")) {
      axios.defaults.headers.common["X-WP-Nonce"] = universityData.nonce;   // Set globally
  ...
  findNearestParentLi(el) {     // Whether button is clicked or the fontawesome symbol is clicked go to the parent li element
    let thisNote = el;
